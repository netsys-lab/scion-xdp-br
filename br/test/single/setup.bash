...
sudo ip netns exec sw0 -c 1 ping 10.1.1.1
sudo ip netns exec sw0 -c 1 ping 10.1.2.1
sudo ip netns exec sw0 -c 1 ping 10.2.0.0
sudo ip netns exec sw0 -c 1 ping 10.2.0.2
